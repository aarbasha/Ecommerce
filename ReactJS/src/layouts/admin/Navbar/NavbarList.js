...
const NavbarList = () => {
  const { name } = useSelector(state => state.profile.data)
                  ...
                  >
                    <div className="user-setting d-flex align-items-center gap-1">
...

                      {
                        avatarPreview !== null ?
                          <>
                            <img src={avatarPreview ? avatarPreview : inputs.avatar !== "avatar" ?
                      ...
                      <div className="user-name d-none d-sm-block">
                        {
                          name ? name : inputs.name ? inputs.name : null
                        }
                      </div>
                    </div>
                  </a>
                        ...
                        <div className="d-flex align-items-center">
                          ...
                          <div className="ms-3">
                            ...
                            <span className="mb-0 dropdown-user-designation text-secondary">
                              {
                                username ? username : inputs.username ? inputs.username : null
                              }
                            </span>
                          </div>
                        </div>
